...
export const langJa: Partial<TranslationObject> = {
  ...
  'settings.manage.custom_views.name_desc': 'ビューは以下のURLで利用可能になります:',
  ...
  'settings.manage.custom_views.accepted_format': '許可される形式: .html, 最大',
  ...
  'settings.manage.manage_rundowns.delete_confirm': 'この進行表を削除してもよろしいですか？',
  'settings.manage.manage_rundowns.delete_button': '進行表を削除',
  'settings.manage.manage_rundowns.load_title': '進行表の読み込み',
  'settings.manage.manage_rundowns.load_confirm': 'この進行表を読み込んでもよろしいですか？',
  ...
  'settings.manage.manage_rundowns.error_title_alphanumeric': 'タイトルは英数字である必要があります',
  'settings.manage.custom_fields.performance_warning_1': 'カスタムフィールドが多数あります。',
  'settings.manage.custom_fields.performance_warning_2':
    'パフォーマンスを向上させるため、使用していないフィールドの削除を検討してください。',
  ...
  'settings.manage.custom_fields.label': 'ラベル',
  ...
  'settings.manage.custom_fields.key_description': 'フィールドの一意の識別子。',
  ...
  'settings.manage.gsheet_setup.setup_authenticate':
    '認証が必要です。Googleスプレッドシートを使用するには認証を行ってください。',
  'settings.manage.gsheet_setup.setup_idle':
    'Googleドライブから進行表を直接読み込むために、Googleスプレッドシート連携を設定してください。',
  'settings.manage.gsheet_setup.title': 'Googleスプレッドシートの設定',
  ...
  'settings.manage.gsheet_setup.copy_code_hint': '認証成功後にGoogleから提供されたコードを貼り付けてください。',
