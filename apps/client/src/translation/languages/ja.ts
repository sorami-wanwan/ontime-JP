...
export const langJa: TranslationObject = {
  ...
  'settings.save': '保存',
  'settings.revert_to_saved': '保存時に戻す',
  'settings.title': '設定',
  ...
  'settings.general.editor_pin_code_description': 'PINコードでエディタ画面を保護する',
  'settings.general.operator_pin_code': 'オペレーターPINコード',
  'settings.general.operator_pin_code_description': 'PINコードでオペレーター画面とキューシートを保護する',
  ...
  'settings.view.override_disabled': 'カスタムスタイルシートでビューのスタイルを上書きする',
